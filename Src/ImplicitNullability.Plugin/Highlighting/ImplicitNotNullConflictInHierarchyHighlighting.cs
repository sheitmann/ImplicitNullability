...
namespace ImplicitNullability.Plugin.Highlighting 
{
    ...
    {
        private const string SeverityId = "ImplicitNotNullConflictInHierarchy";
        private const string Message = "Implicit NotNull conflicts with nullability in base type";
